...
\begin{figure}%
    \centering
    \subfloat[\centering Low Dimension Representation of Adaboost Decision Surface]{{\includegraphics[width=10cm]{statics/PCA_decision_surface.png} }}%
    \qquad
    \subfloat[\centering Low Dimension Representation of Logistic Regression Decision Surface]{{\includegraphics[width=10cm]{statics/log_reg_decision_surface.png} }}%
