...
\begin{figure}
    \centering
    \subfloat[\centering Test - Image 1]{{\includegraphics[width=0.48\textwidth]{ada_test_prob.png} }}
    \qquad
    \subfloat[\centering Train - Image 2]{{\includegraphics[width=0.48\textwidth]{ada_train_prob1.png} }}
    \qquad
    \subfloat[\centering Train - Image 3]{{\includegraphics[width=0.48\textwidth]{ada_train_prob2.png} }}
...
\begin{figure}
    \centering
    \subfloat[\centering Low Dimension Representation of Adaboost Decision Surface]{{\includegraphics[width=0.48\textwidth]{statics/PCA_decision_surface.png} }}
    \qquad
    \subfloat[\centering Low Dimension Representation of Logistic Regression Decision Surface]{{\includegraphics[width=0.48\textwidth]{statics/log_reg_decision_surface.png} }}
