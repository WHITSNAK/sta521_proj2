...
\\
Another analysis is to fix a model threshold and observe the induce TPR rate and FPR rate. However to make this more operational, we instead fix a chosen FPR rate, and compute the TPR rate based on the induced threshold needed to obtain that FPR rate, intuitively this allows an end user to fix an acceptable level of false positive rate. We demonstrate an example where the false positive rate is low, set at 0.3. We see that for this, most models are able to attain a TPR above 0.8 under both test schemes. 
...
\begin{figure}
    \centering
    \subfloat[\centering Test - Image 1]{{\includegraphics[width=0.48\textwidth]{ada_test_prob_tr_23_te_1.png} }}
    \qquad
    \subfloat[\centering Train - Image 2]{{\includegraphics[width=0.48\textwidth]{ada_train_prob1_tr_23_te_1.png} }}
    \qquad
    \subfloat[\centering Train - Image 3]{{\includegraphics[width=0.48\textwidth]{ada_train_prob2_tr_23_te_1.png} }}
...
\begin{figure}[!h]
    \centering
    \subfloat[\centering Low Dimension Representation of Adaboost Decision Surface]{{\includegraphics[width=0.48\textwidth]{statics/PCA_decision_surface_tr_23_te_1.png} }}
    \qquad
    \subfloat[\centering Low Dimension Representation of Logistic Regression Decision Surface]{{\includegraphics[width=0.48\textwidth]{statics/log_reg_decision_surface_tr_23_te_1.png} }}
...
\begin{figure}[!h]
    \centering
    \subfloat[\centering Histograms of NDAI, Corr and SD, between mis-classified and correctly classified non-cloud data points. Blue histograms represent the distribution of features of points that are correctly classified and orange those that are mis-classified]{{\includegraphics[width=0.48\textwidth]{statics/feature_compare_true_neg_tr_23_te_1.png} }}
    \qquad
    \subfloat[\centering Train - Image 2]{{\includegraphics[width=0.48\textwidth]{feature_compare_true_pos_tr_23_te_1.png} }}
...
To check the robustness of our conclusions about Adaboost in the earlier sections, we vary the images used for training and that for testing. This time, we use images 1 and 2 for training and 3 for testing. This is a significant change due to the larger number of cloud labelled data points in image 1. 
...
Once again we see that the main driver of misclassification is with the differing distribution of NDAI. In-fact with the larger number of true positive (cloud) points in the training set, the differences in NDAI are even more apparent. 
...
\begin{figure}[!h]
    ...
    \qquad
    \subfloat[\centering Train - Image 2]{{\includegraphics[width=0.48\textwidth]{feature_compare_true_pos_tr_12_te_3.png} }}
    \caption{Histograms of NDAI, Corr and SD, between mis-classified and correctly classified cloud data points. Blue histograms represent the distribution of features of points that are correctly classified and orange those that are mis-classified}
    \caption{Decision Surfaces of Adaboost (Top) and Logistic Regression (Bottom). }
    \label{fig:decision_surface_alt}
\end{figure}
